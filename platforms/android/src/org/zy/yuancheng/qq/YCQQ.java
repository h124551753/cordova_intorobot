...
//							loginListener);
    ...
    private boolean getUserInfo(CallbackContext callbackContext){
        currentCallbackContext = callbackContext;
        UserInfo mInfo = new UserInfo(this.cordova.getActivity(), mTencent.getQQToken());
        mInfo.getUserInfo(qqGetUserInfoListener);
        return true;
     ...
     * QQ获取用户信息
     */
    IUiListener qqGetUserInfoListener = new IUiListener() {        
        @Override
        ...
        public void onComplete(Object response) {
            ...
            YCQQ.this.webView.sendPluginResult(new PluginResult(
                   PluginResult.Status.OK, jsonResponse), currentCallbackContext.getCallbackId());
        }
